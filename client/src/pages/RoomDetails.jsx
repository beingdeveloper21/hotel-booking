...
const RoomDetails = () => {
  ...
  return room && (
    ...
    <div className='mt-25 space-y-4'>
        {roomCommonData.map((specf,index)=>(
            <div key={index} className='flex items-start gap-2 '>
                <img src={specf.icon} alt={`${specf.title}-icon`} className='w-6.5'/>
                <div >
    ...
    <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability.You get a comfortable Two bedroom apartment with true city feeling.The price quoted is for two guest,at the guest slot please mark the number of guests to get the exact price for groups.The Guests will be allocated ground floor according to  availability.You get the comfortable two bedroom apartment that has a true city feeling. </p>
    </div>
    {/* Hosted By */}

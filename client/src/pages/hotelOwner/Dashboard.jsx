         ...
         <tbody className='text-sm'>
            {dashboardData.bookings.map((item,index)=>(
              <tr key={index}>
               ...
               <td className='max-sm:hidden py-3 px-4 text-gray-700 border-t border-gray-300'>{item.room.roomType}</td>
               <td className='text-center py-3 px-4 text-gray-700 border-t border-gray-300'>{currency}{item.totalPrice}</td>

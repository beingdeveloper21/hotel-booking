...
const AddRoom = () => {
  ...
  const { axios, getToken, fetchRooms } = useAppContext(); // ✅ include fetchRooms
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // ✅ Fetch updated rooms in context so home page updates immediately
        await fetchRooms();
  ...
  return (
    <form onSubmit={onSubmitHandler} className="p-4">
      <Title
        ...
        font="Outfit"
        title="Add Room"
        subTitle="Fill in the details carefully with accurate room details, pricing, and amenities."
      />
